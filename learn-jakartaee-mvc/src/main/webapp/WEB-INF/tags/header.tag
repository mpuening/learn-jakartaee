...
<div id="header">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a id="app-name" class="navbar-brand" href="<c:url value="/"/>">Learn Jakarta EE MVC</a>
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<c:if test="${mainNavBarSelected!=null and mainNavBarSelected=='true'}">
					<a href="<c:url value="/mvc/main/aircraft"/>"
				...
				<c:if test="${mainNavBarSelected==null or mainNavBarSelected!='true'}">
					<a href="<c:url value="/mvc/main/aircraft"/>" class="nav-item nav-link">Main</a>
				</c:if>

				<c:if test="${adminNavBarSelected!=null and adminNavBarSelected=='true'}">
					<a href="<c:url value="/mvc/admin/events"/>" class="nav-item nav-link active">Admin<span
						class="sr-only">(current)</span>
					</a>
				</c:if>
				<c:if test="${adminNavBarSelected==null or adminNavBarSelected!='true'}">
					<a href="<c:url value="/mvc/admin/events"/>" class="nav-item nav-link">Admin</a>
				</c:if>
			</div>
		</div>
	</nav>
