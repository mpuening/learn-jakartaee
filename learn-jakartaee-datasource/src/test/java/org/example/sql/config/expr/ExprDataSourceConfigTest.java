...
public class ExprDataSourceConfigTest {

	@Deployment(testable = true)
	public static WebArchive createTestDeployment() {

		System.setProperty(Environment.PROFILES_PROPERTY_NAME, "none");

		return new WebAppWarBuilder("learn-jakartaee-datasource")
				.packages("io.github.learnjakartaee.sql", "org.example.sql.config.expr")
				.build();
	}
