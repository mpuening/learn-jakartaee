...
@DataSourceDefinition(
		...
		className = "org.example.sql.config.el.ELConfigurableDataSource",
		url = "ENV(db.url)",
...
public class ELDataSourceConfiguration {
	...
	public void onStart(@Observes @Initialized(ApplicationScoped.class) Object unused) {
		...
		Environment environment = new ConfigurableEnvironment(ELDataSourceConfiguration.class.getClassLoader(), evaluator);
